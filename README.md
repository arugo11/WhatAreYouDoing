...
- **6つの行動カテゴリー自動分類**: PC作業、ゲーム、睡眠、スマホ操作、不在、その他
- **物理オブジェクト判定**: ゲームコントローラーの配置でPC作業/ゲームを区別
- **リアルタイム環境監視**: 温度、湿度、照度の同時測定
- **RESTful API**: 簡単な統合とデータ取得
- **自動データ管理**: SQLiteデータベースによる履歴保存
...
- [M5Stack ESP32-CAM ドキュメント](https://docs.m5stack.com/en/unit/esp32cam)
...
{
  "pending_events": 0,
  "latest_event_time": "2025-07-13T00:36:37.139329",
  "latest_status": "AWAY",
  "timestamp": "2025-07-13T00:37:31.873695"
}
```
...
**WhatAreYouDoing?** で、あなたの日常行動をスマートに記録・分析してみませんか？ 🚀 